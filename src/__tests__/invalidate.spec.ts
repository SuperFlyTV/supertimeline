...
describeVariants(
	...
	(test, fixTimeline, _getCache) => {
		...
		test('Changing timeline', () => {
			...
			expect(resolved.statistics.resolvingObjectCount).toEqual(3)
			...
			expect(resolved3.statistics.resolvingObjectCount).toEqual(3)
			...
			expect(resolved4.statistics.resolvingObjectCount).toEqual(0)
		...
		test('Updating objects', () => {
...

			{
				...
				expect(resolved.statistics.resolvingObjectCount).toEqual(1)
